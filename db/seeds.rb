...
5.times do
  order = Order.create(sales_order_number: Faker::Alphanumeric.alphanumeric(number: 6), vendor_purchase_order_number: Faker::Alphanumeric.alphanumeric(number: 11), shipping_method: 'SAMPLE', shipping_account_number: '1234', test_order: 'test', shipping_details: {IOSS: 'GB295849305'})
